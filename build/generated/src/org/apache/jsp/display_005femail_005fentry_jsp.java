...
public final class display_005femail_005fentry_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <h1 id=\"center\">Thanks for joining the forum!</h1>\n");
      out.write("        ");
      out.write("\n");
      out.write("        ");
      forum.User user = null;
      synchronized (session) {
        user = (forum.User) _jspx_page_context.getAttribute("user", PageContext.SESSION_SCOPE);
        if (user == null){
          user = new forum.User();
      ...
      out.write("              <p> Please take a survey on your registration experience</p>\n");
      out.write("              \n");
      out.write("              <form action=\"SqlGatewayServlet4\" method=\"post\">\n");
      out.write("                <input id=\"tweet2\" type=\"submit\" value =\"Survey\">\n");
      out.write("            </form>\n");
      out.write("            </div>\n");
      out.write("    </body>\n");
      out.write("</html>\n");
